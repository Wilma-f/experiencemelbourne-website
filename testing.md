...
Test Execution Schedule:Start Date: 2/09/2024
                           End Date: 2/09/2024
 Accessibility Test Cases:
1.Alt Text Check: Verify that images on the website have descriptive alt attributes to aid users who rely on screen readers.
2.Colour Contrast: Confirm that text has sufficient contrast against its background to be readable by users with visual impairments.
3.Content understandability and navigation: Check the website content to ensure it is clear, simple, and easy to navigate.
4.Keyboard Navigation: check that all interactive elements are accessible and navigable using a keyboard.
# Test Case 3:  Alt Text Check, Colour Contrast, Content understandability and navigation
...
<img width="405" height="161" alt="image" src="https://github.com/user-attachments/assets/eceb25d1-edda-44c2-8dc1-a69faf348702" />


# Test case 4: Keyboard Navigation
1.WebDev Tools: Verify focus indicators and tab order using DevTools.
2.WAVE Extension: Identify and address accessibility issues related to keyboard navigation.
3.Manual Testing: Test for the keyboard navigation and focus visibility.
Steps to execute:
# For WebDev Tools:
...
# For Manual Testing: 
    Use the Tab key to navigate through the website and ensure that all interactive elements (links, buttons, form fields) are reachable and in a logical order.
...
Test Execution Schedule: Start Date: 3/09/2024
                           End Date: 3/09/2024
Test Cases:
